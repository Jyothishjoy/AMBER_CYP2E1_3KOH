1. Read Autodock Tutorial.pdf

2. Download Autodock4 (https://autodock.scripps.edu/download-autodock4/), Autodock Tools (https://ccsb.scripps.edu/mgltools/downloads/).
  
3. Prepare substrate:
   
     a. Optimize substrate using DFT. Save as pdb file using Gaussview (“sub.pdb”).

4. A useful tip for preparing the enzyme:
...
5. Follow the steps exactly as described in the Autodock Tutorial.pdf
